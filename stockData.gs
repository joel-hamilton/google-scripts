function onOpen() {
    ...
    var menuEntries = [{ name: "Update All Stocks", functionName: "updateStocks" },{ name: "Update Selected Stocks", functionName: "updateSelectedStocks" }];
...
// TODO pull Row1 headings, so this can be run in any sheet with tickers in ColA
    ...
    if (activeRangeList && selectedOnly) { // only updating selected lines
...
//     var info = {};
//     var url = "https://www.reuters.com/companies/XOM" + ticker + "/key-metrics";

//     var res = UrlFetchApp.fetch(url, { muteHttpExceptions: true });
//     var html = res.getContentText();
//     var $ = Cheerio.load(html);
//     Logger.log($('.CompanyQuotePage-body-container-19ttA').html());
//     return {};

//     $('.panel tr.data th').each(function () {
//         info[$(this).text()] = $(this).next().text();
//     });
...
// set values on a single row, beginning with 6th col
